...
Write-Host "=== BackupS3 Manager v24.7 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.7"'){
    throw "ApiBridge.cs version is not 24.7"
}
Write-Host "[OK] desktop API version 24.7" -ForegroundColor Green
