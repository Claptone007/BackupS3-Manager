...
Write-Host "=== BackupS3 Manager v24.8 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.8"'){
    throw "ApiBridge.cs version is not 24.8"
}
Write-Host "[OK] desktop API version 24.8" -ForegroundColor Green
