...
Write-Host "=== BackupS3 Manager v24.13 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.13"'){
    throw "ApiBridge.cs version is not 24.13"
}
Write-Host "[OK] desktop API version 24.13" -ForegroundColor Green
