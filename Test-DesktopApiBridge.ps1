...
Write-Host "=== BackupS3 Manager v24.6 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.6"'){
    throw "ApiBridge.cs version is not 24.6"
}
Write-Host "[OK] desktop API version 24.6" -ForegroundColor Green
