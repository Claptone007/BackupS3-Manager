...
Write-Host "=== BackupS3 Manager v24.11 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.11"'){
    throw "ApiBridge.cs version is not 24.11"
}
Write-Host "[OK] desktop API version 24.11" -ForegroundColor Green
