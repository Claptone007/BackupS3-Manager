...
Write-Host "=== BackupS3 Manager v24.12 API bridge source check ===" -ForegroundColor Cyan
...
if($api -notmatch 'CurrentVersion\s*=\s*"24\.12"'){
    throw "ApiBridge.cs version is not 24.12"
}
Write-Host "[OK] desktop API version 24.12" -ForegroundColor Green
